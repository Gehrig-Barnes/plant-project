        ...
        <div>
            ...
            <Row className="justify-content-md-center">
                <Col>
                    ...
                    <Figure>
                        <Figure.Image width="300"src="https://p.kindpng.com/picc/s/2-27358_pot-plant-clipart-transparent-pot-plant-png-clipart.png" />
                    </Figure>
                </Col>
                <Col>
                    { showLogin ? (
                        <>
                            ...
                            <div className="sign_up">Don't have an account? &nbsp;
